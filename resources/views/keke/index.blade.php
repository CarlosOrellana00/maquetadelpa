...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
  ...
  <header class="app-header navbar">
    ...
    <a class="navbar-brand" href="http://delpatesting.cl">
      <img class="navbar-brand-full" src="http://delpatesting.cl/img/logos/logo.png" height="70" alt="InfyOm Logo" />
    </a>
    ...
    <nav class="nav-header navbar navbar-expand-lg navbar-light">
      <div class="navbar-collapse collapse" id="basic-navbar-nav">
        <div class="mr-center navbar-nav">
          <a href="http://delpatesting.cl" data-rb-event-key="home"
            class="padding-link color-nav border-right nav-link">Transportes</a>
                ...
                <div class="card-body">
                  <form method="POST" action="http://52.14.50.96/perfil/storePersonal" accept-charset="UTF-8"
                    ...
                    enctype="multipart/form-data"><input name="_token" type="hidden"
                      value="8NwQORIW6rEK93QjN51dQpvVrmb3rHELd9LxG2aG">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input class="form-control update-last-name set-value-storage" name="last_name"
                                type="text" value="Orellana">
                            </div>
                          </div>
